...
#define SSID "TP-LINK_B306" //replace x with your wifi network name
#define PASS "Nesara123" //replace x with your wifi network password
...
void setup()
{
  ...
  Serial.begin(115200);// begin the serial communication with baud of 9600
  esp8266.begin(115200);// begin the software serial communication with baud rate 9600
...
void loop(){
  ...
  if(data<10){ //check if sensor value is less then 76
